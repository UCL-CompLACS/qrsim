classdef TaskPlumeMultiHeliMultiSourceGaussianDispersion<Task
    ...
    %
    % TaskPlumeMultiHeliMultiSourceGaussianDispersion methods:
    ...
    methods (Sealed,Access=public)
        ...
        function obj = TaskPlumeMultiHeliMultiSourceGaussianDispersion(state)
            obj = obj@Task(state);
        end
