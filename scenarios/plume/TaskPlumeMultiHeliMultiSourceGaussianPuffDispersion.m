classdef TaskPlumeMultiHeliMultiSourceGaussianPuffDispersion<Task
    % Plume mapping task in which several helicopters are used
    ...
    %
    % TaskPlumeMultiHeliMultiSourceGaussianPuffDispersion methods:
    ...
    methods (Sealed,Access=public)
        ...
        function obj = TaskPlumeMultiHeliMultiSourceGaussianPuffDispersion(state)
            obj = obj@Task(state);
        end
