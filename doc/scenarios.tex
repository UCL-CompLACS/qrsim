...
\begin{figure}[t]
\centering
\subcaptionbox{Single source Gaussian concentration.\label{fig:singlegaussplume}}{\includegraphics[width=0.48\textwidth]{singlegaussplume.jpg}}
\subcaptionbox{Multiple sources Gaussian dispersion.\label{fig:multigaussplume}}{\includegraphics[width=0.48\textwidth]{multigaussplume.jpg}}
\subcaptionbox{Single source Gaussian puff dispersion.\label{fig:singlegausspuffplume}}{\includegraphics[width=0.48\textwidth]{singlegausspuffplume.jpg}}
...
\bibitem{impj} N. Dalal, B. Triggs. {\em Histograms of Oriented Gradients for Human Detection}, {IEEE} Conference on Computer Vision \& Pattern Recognition (CVPR), vol. II, pages 886-893, June 2005.
