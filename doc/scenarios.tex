...
\centering
\subfigure[$t=0$]{
\includegraphics[width=0.48\textwidth]{catmousestart.jpg} 
\label{fig:catmousestart}}
\subfigure[$t=T$]{
\includegraphics[width=0.48\textwidth]{catmousestop.jpg}
...
\includegraphics[width=0.48\textwidth]{singlegaussplume.jpg}
\label{fig:singlegaussplume}}
\subfigure[Multiple sources Gaussian dispersion.]{
\includegraphics[width=0.48\textwidth]{multigaussplume.jpg}
\label{fig:multigaussplume}}
\subfigure[Single source Gaussian puff dispersion.]{
\includegraphics[width=0.48\textwidth]{singlegausspuffplume.jpg}
...
Despite the latest advancement in the domain of computer vision (\cite{handa2012}), simulating from first principles camera images for general outdoor scenes like the one we consider in our scenario, is still infeasible. Similarly is all but trivial to construct an accurate first principle model of an image classifier. 

For those reason we preferred to rely on experimental data 
Real world imaging and classification systems are highly complex and affected by a variety of  
 
In this section we give more details about the camera/classifier model employed in the search and rescue scenario.

Due to the multitude of processes that are in play in generating the  

\begin{figure}[ht]
\centering
\subfigure[Camera image]{
\includegraphics[width=0.48\textwidth]{classimg.jpg} 
\label{fig:aerialimg}}
\subfigure[HOG classifier scores]{
\includegraphics[width=0.48\textwidth]{classscores.jpg}
...
\caption{Gaussian plume dispersion driven by wind.\label{fig:winddisp}}
\end{figure}
...
\bibitem{impj} N. Dalal, B. Triggs. {\em Histograms of Oriented Gradients for Human Detection}, Proceedings of the {IEEE} Conference on Computer Vision \& Pattern Recognition (CVPR), vol. II, pages 886-893, June 2005.
