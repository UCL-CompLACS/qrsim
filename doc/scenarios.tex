...
We remind the reader that within the simulator the helicopter state $x^i$ is denoted as \mytexttt{eX}:
...
while the actions $a^i$ are denoted as controls \mytexttt{u}:
