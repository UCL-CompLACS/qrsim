...
To only compile the client side of the TCP interface cmake can be also accepts the \texttt{-DCLIENT_ONLY=ON} switch which allows in order to only build the C++ client library.
