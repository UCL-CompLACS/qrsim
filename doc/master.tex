...
\begin{itemize}
 ...
 \item the pseudo-random number generator streams \texttt{state.rStreams}, used by any of the objects that requires any form of random numbers (e.g. to simulate noise samples);
