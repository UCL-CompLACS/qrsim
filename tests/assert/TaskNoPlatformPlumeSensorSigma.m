classdef TaskNoPlatformPlumeSensorSigma<Task
    % Task used to test assertions on DT
    %
    methods (Sealed,Access=public)
                
        function obj = TaskNoPlatformPlumeSensorSigma(state)
            obj = obj@Task(state);
        end
        ...
        function taskparams=init(obj)
            ...
            taskparams.platforms(1).configfile = 'pelican_config_no_plume_sensor_sigma';
