classdef TaskNoPlatformCameraObsModelType<Task
    ...
    methods (Sealed,Access=public)
        ...
        function obj = TaskNoPlatformCameraObsModelType(state)
            obj = obj@Task(state);
        end
        ...
        function taskparams=init(obj) 
            ...
            for i=1:obj.numUAVs,
                taskparams.platforms(i).configfile = 'pelican_with_camera_no_camera_obsmodel_type';
            end
        end
