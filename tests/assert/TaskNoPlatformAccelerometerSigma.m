classdef TaskNoPlatformAccelerometerSigma<Task
    % Task used to test assertions on DT
    %
    methods (Sealed,Access=public)
                        
        function obj = TaskNoPlatformAccelerometerSigma(state)
            obj = obj@Task(state);
        end
        ...
        function taskparams=init(~)
            ...
            taskparams.platforms(1).configfile = 'pelican_config_no_accelerometer_sigma';
