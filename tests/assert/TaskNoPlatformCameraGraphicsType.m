classdef TaskNoPlatformCameraGraphicsType<Task
    ...
    methods (Sealed,Access=public)
        ...
        function obj = TaskNoPlatformCameraGraphicsType(state)
            obj = obj@Task(state);
        end
        ...
        function taskparams=init(obj) 
            ...
            for i=1:obj.numUAVs,
                taskparams.platforms(i).configfile = 'pelican_with_camera_no_camera_graphics_type';
            end  
