classdef TaskNoGaussianPuffDispersionNumSamplesPerLocation<Task
    ...
    methods (Sealed,Access=public)
        ...
        function obj = TaskNoGaussianPuffDispersionNumSamplesPerLocation(state)
            obj = obj@Task(state);
        end
        ...
        function taskparams=init(obj) 
            ...
            for i=1:obj.numUAVs,
                taskparams.platforms(i).configfile = 'pelican_config_plume_ok'; 
            end            
        end
