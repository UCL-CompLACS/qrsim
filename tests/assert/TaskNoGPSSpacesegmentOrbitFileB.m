classdef TaskNoGPSSpacesegmentOrbitFileB<Task
    % Task used to test assertions on DT
    %
    methods (Sealed,Access=public)
                
        function obj = TaskNoGPSSpacesegmentOrbitFileB(state)
            obj = obj@Task(state);
        end
        ...
        function taskparams=init(obj)
            ...
            taskparams.environment.gpsspacesegment.PR_BETA =  1.005;  % process time constant   
