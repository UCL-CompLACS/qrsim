classdef TestTaskPlumeSingleSourceGaussianDispersion<Task
    ...
    methods (Sealed,Access=public)
        ...
        function obj = TestTaskPlumeSingleSourceGaussianDispersion(state)
            obj = obj@Task(state);
        end
        ...
        function taskparams=init(obj) 
            ...
            taskparams.environment.area.type = 'GaussianDispersionPlumeAreaForTesting';
            ...
            for i=1:obj.numUAVs,
                taskparams.platforms(i).configfile = 'pelican_config_plume_noisy'; 
            end            
        end
