...
c.sensors.plumesensor.on = 1;               % if off the plume sensor is noiseless 
c.sensors.plumesensor.type = 'PlumeSensorG';% type of plume sensor
c.sensors.plumesensor.dt = 0.02;            % update rate of the plume sensor
c.sensors.plumesensor.SIGMA = 0.01;            % update rate of the plume sensor
