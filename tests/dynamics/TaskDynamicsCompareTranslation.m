classdef TaskDynamicsCompareTranslation<Task
    ...
    methods (Sealed,Access=public)
        ...
        function obj = TaskDynamicsCompareTranslation(state)
            obj = obj@Task(state);
        end
        ...
        function taskparams=init(~)
            ...
            taskparams.environment.area.limits = [-300 300 -300 300 -200 0];
            ...
            taskparams.platforms(1).configfile = 'pelican_config_dynamics_translation';
