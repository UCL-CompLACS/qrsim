classdef TaskCompareWindWithSimulinkW2D0<Task
    ...
    methods (Sealed,Access=public)
        ...
        function taskparams=init(obj)
            ...
            taskparams.environment.wind.direction = degsToRads(0); %mean wind direction, rad clockwise from north set to [] to initialise it randomly
            taskparams.environment.wind.W6 = ftToM(2);  % velocity at 6m from ground in m/s
            
            %%%%% platforms %%%%%
            % Configuration and initial state for each of the platforms
            taskparams.platforms(1).configfile = 'pelican_config_compare_wind_with_simulink_w2_d0';
