...
c.aerodynamicturbulence.direction = degsToRads(30); % mean wind direction, (rad clockwise from north set to [] to initialise randomly)
c.aerodynamicturbulence.W6 = ftToM(2);  % velocity at 6m from ground in m/s
